...
//---------------------------部署前测试--------------------------
                ...
                choice(
                        choices: ['false', 'true'],
                        description: '是否需要执行Junit单元测试，true需要，false不需要',
                        name: 'NEED_JUNIT'
                ),
                choice(
                        choices: ['false', 'true'],
...
//---------------------------部署后测试--------------------------
                choice(
                        choices: ['false', 'true'],
                        description: '是否需要执行接口测试，true需要，false不需要',
                        name: 'NEED_API_TEST'
                ),
                text(
                        defaultValue: 'ApiCaseDemo.xlsx',
                        description: '后端项目在代码仓库的测试用例文件名。后端项目必填',
                        name: 'APITestCase'
                ),
                choice(
                        choices: ['false', 'true'],
                        description: '是否需要执行性能测试，true需要，false不需要',
                        name: 'NEED_PM_TEST'
                ),
                text(
...
def RELEASEDIR = "dist" //前端项目编译产物的目录
...
/*
前端项目容器外静态资源目录
前端项目如果需要使用容器外资源，用户需要在此处指定静态资源的目录。
nginx访问的外部资源需要指向用户配置的启动容器的宿主机目录。
该配置默认为空，表示不使用容器外资源。
*/
